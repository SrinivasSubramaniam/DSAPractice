...
String st = “(()))” -> 1 bracket  
    ...
    public void test1(){
       String str="2[ab3[b]]"; 
       Assert.assertTrue(stackTest(str).equals("abbbbabbbb"));
        
    }
	@Test
    public void test4(){
       String str="2[ab3[ba]]"; 
       Assert.assertTrue(stackTest(str).equals("abbababaabbababa"));///bbb///abbababaabbababa
        
    }
	@Test
    public void test2(){
       String str="a3[c]"; 
       Assert.assertTrue(stackTest(str).equals("accc"));
